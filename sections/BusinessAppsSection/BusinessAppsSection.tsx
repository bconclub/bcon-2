...
interface BusinessApp {
  ...
  video_url?: string;
  vimeo_id?: string;
  case_study_url: string; // PHASE 2: href="/work/..." - will show Coming Soon modal
}

interface BusinessAppsSectionProps {
...
interface BusinessAppModalPropsWithHandler extends BusinessAppModalProps {
  onCaseStudyClick?: () => void;
}

function BusinessAppModal({ app, isOpen, onClose, onCaseStudyClick }: BusinessAppModalPropsWithHandler) {
    ...
    <div className="business-apps-modal-backdrop" onClick={onClose}>
      <div className="business-apps-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="business-apps-modal-footer">
          {/* PHASE 2: Show Coming Soon modal instead of navigating to case study */}
          {/* <a
