...
function BusinessAppModal({ app, isOpen, onClose }: BusinessAppModalProps) {
  ...
  const [isDetailsRevealed, setIsDetailsRevealed] = useState(false); // Start hidden - video full screen
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setIsDetailsRevealed(false); // Start with video full screen
  ...
  // Note: Details are always visible now, so this is kept for potential future use
  useEffect(() => {
    if (!isOpen) return;
  ...
  return (
    <div className="business-apps-modal-backdrop" onClick={onClose}>
      ...
      >
        ...
        {/* Reveal Button - Show when details are not revealed, positioned at absolute bottom */}
        {!isDetailsRevealed && (
          <button 
        ...
        >
          <div className={`business-apps-modal-description-content ${isDetailsRevealed ? 'expanded' : ''}`}>
            {/* Product Header in Description */}
            <div className="business-apps-modal-product-header" style={{ padding: '0', marginBottom: '0' }}>
              <h3 
                className="business-apps-modal-product-name"
                style={{ 
              ...
              {app.tagline && (
                <p 
                  className="business-apps-modal-product-tagline"
                  style={{
                    fontFamily: "'Anybody', sans-serif",
                    fontSize: '16px',
                    fontWeight: 400,
            ...
            {app.description && (
              <div className="business-apps-modal-description-inner" style={{ padding: '0' }}>
                <h4 
                  className="business-apps-modal-description-title"
                  style={{
                    fontFamily: "'Anybody', sans-serif",
                    fontSize: '14px',
                    fontWeight: 600,
          ...
          >
            ...
            >
              ...
              >
                ...
                {currentApp.vimeo_id ? (
                  <iframe
                    src={`https://player.vimeo.com/video/${currentApp.vimeo_id}?autoplay=1&loop=1&controls=0&title=0&byline=0&portrait=0&muted=1&background=1&dnt=1${currentVimeoStart}`}
