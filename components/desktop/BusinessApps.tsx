        ...
        <div className="business-apps-desktop-content">
          ...
          <div ref={contentRef} className="business-apps-details-container">
            ...
            {currentApp.description && (
              <div className="business-apps-description-section">
                <h4 className="business-apps-description-title">Overview</h4>
                <p className="business-apps-description-text">{currentApp.description}</p>
              </div>
            )}
