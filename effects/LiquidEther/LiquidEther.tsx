...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Shader code strings (keeping as-is)
    const face_vert = `
...
`;
    ...
    // Simplified class definitions with proper types
    class ShaderPass {
      props: any;
      uniforms: any;
    ...
    const applyOptionsFromProps = () => {
      ...
      if (webgl.autoDriver) {
        ...
        if (webgl.autoDriver.mouse) {
          (webgl.autoDriver.mouse as any).autoIntensity = autoIntensity;
  ...
  useEffect(() => {
    ...
    if (webgl.autoDriver) {
      ...
      webgl.autoDriver.resumeDelay = autoResumeDelay;
      webgl.autoDriver.rampDurationMs = autoRampDuration * 1000;
      if ((webgl.autoDriver as any).mouse) {
        (webgl.autoDriver as any).mouse.autoIntensity = autoIntensity;
